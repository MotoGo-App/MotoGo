...
try {
  ...
  const forbiddenPatterns = [/prisma\.\w+\.delete\(/, /prisma\.\w+\.deleteMany\(/];
  ...
  if (violations.length > 0) {
    ...
    console.error(
      'Do not modify this file to bypass this check in development environment as production and deployment database can be shared.'
    );
    process.exit(1);
  }
} catch (err: any) {}
